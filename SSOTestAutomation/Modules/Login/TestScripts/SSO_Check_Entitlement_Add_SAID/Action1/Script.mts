'###############################################################################################################
'Test Script Name                          :  SSO_Check_Entitlement_Add_SAID
'Test Objective/Description         	   :  To Login and Logout into OSP Application
'Test Case ID                              :  SSO_Check_Entitlement_Add_SAID
'Test Case Name                            :  SSO_Check_Entitlement_Add_SAID
'Author                                    :  Anil Kumar V
...
'****************************************Setting the Project Name in the environment variable*******************************************************
                ...
                environment("StrTestCaseID")="SSO_Check_Entitlement_Add_SAID"
                strModuleName= environment("strModuleName")				

                strTestCaseName= environment("TestName")
                environment("strTestCaseName")="SSO_Check_Entitlement_Add_SAID"
                StrStartTime=now
                StrBeginTimer=Timer
...
'#################################### TEST  CASE VALIDATION STARTS HERE ##################################################################################
                ...
                DataTable.ImportSheet environment("strDataFile"), "OSP_Check_Entitlement", "Global"
