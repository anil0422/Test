'###############################################################################################################
'Test Script Name                          :  SSO_Validate_Employee_Access
'Test Objective/Description         	   :  To Login and Logout into OSP Application
'Test Case ID                              :  SSO_Validate_Employee_Access
''Test Case Name                            :  SSO_Validate_Employee_Access
'Author                                    :  Anil Kumar V
...
'****************************************Setting the Project Name in the environment variable*******************************************************
                ...
                environment("StrTestCaseID")="SSO_Validate_Employee_Access"
                strModuleName= environment("strModuleName")				

                strTestCaseName= environment("TestName")
                environment("strTestCaseName")="SSO_Validate_Employee_Access"
                StrStartTime=now
                StrBeginTimer=Timer
