'###############################################################################################################
'Test Script Name                          :  SSO_Flexcare_Submit_Quote
'Test Objective/Description         	   :  To Login and Logout into OSP Application
'Test Case ID                              :  SSO_Flexcare_Submit_Quote
'Test Case Name                            :  SSO_Flexcare_Submit_Quote
'Author                                    :  Anil Kumar V
...
'****************************************Setting the Project Name in the environment variable*******************************************************
                ...
                environment("StrTestCaseID")="SSO_Flexcare_Submit_Quote"
                strModuleName= environment("strModuleName")				

                strTestCaseName= environment("TestName")
                environment("strTestCaseName")="SSO_Flexcare_Submit_Quote"
                StrStartTime=now
                StrBeginTimer=Timer
...
'							End IF
							...
							avl_crd=split(Obj_wbele_crd_avl.GetROProperty("innertext")," ")
															
							If avl_crd(2)>=2 Then
								Func_CreateRow strDtlRptFileName,strTestCaseName, "We have Credits more than 2 and have total credits of " &avl_crd(2),"DONE	",now
								else
								Func_CreateRow strDtlRptFileName,strTestCaseName, "We don't have required number of credits, available is "&avl_crd(2) ,"FAIL",now	
								Call Func_WriteSummaryReportAndUploadToQC()
								ExitAction "Fail "
							End If
							
							Call Func_Object_Exists(Obj_Wbtn_sbt_nw)			
							Call Func_Do_Action(Obj_Wbtn_sbt_nw,"TRUE","")
							
							Call Func_Object_Exists(Obj_wblst_id_sel)
							Call Func_Do_Action(Obj_wblst_id_sel,Environment("id"),WebList)
							
							Call Func_Object_Exists(Obj_Wbtn_next)			
							Call Func_Do_Action(Obj_Wbtn_next,"TRUE","")
							
							Call Func_Object_Exists(Browser("Welcome - HPE Software").Page("Flexcare Credit Management").WebButton("Select"))			
							Call Func_Do_Action(Browser("Welcome - HPE Software").Page("Flexcare Credit Management").WebButton("Select"),"TRUE","")
							
							Call Func_Object_Exists(Obj_Wbtn_next1)			
							Call Func_Do_Action(Obj_Wbtn_next1,"TRUE","")
							
							Call Func_Object_Exists(Obj_Wbtn_next2)			
							Call Func_Do_Action(Obj_Wbtn_next2,"TRUE","")
							
							Call Func_Object_Exists(obj_wbtd_cmnts)
							Call Func_Do_Action(obj_wbtd_cmnts,Environment("comments"),WebEdit)
							
							Call Func_Object_Exists(Obj_Wbtn_next3)			
							Call Func_Do_Action(Obj_Wbtn_next3,"TRUE","")
							
							wait(1)
							Call Func_Object_Exists(obj_wbchk_agree)	
							obj_wbchk_agree.Set "ON"
							
							Call Func_Object_Exists(Obj_Wbtn_sbt_qt)			
							Call Func_Do_Action(Obj_Wbtn_sbt_qt,"TRUE","")
							
							If Obj_wbele_qt_suc.exist Then
								Func_CreateRow strDtlRptFileName,strTestCaseName, "New Quote Submitted Sucessfully" ,"DONE",now
								else
								Func_CreateRow strDtlRptFileName,strTestCaseName, "Failed to submit new quote" ,"FAIL",now	
								Call Func_WriteSummaryReportAndUploadToQC()
								ExitAction "Fail "								
							End If
