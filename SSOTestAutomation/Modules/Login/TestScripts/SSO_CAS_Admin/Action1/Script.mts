'###############################################################################################################
'Test Script Name                          :  SSO_CAS_Admin
'Test Objective/Description         	   :  To Login and Logout into OSP Application
'Test Case ID                              :  SSO_CAS_Admin
'Test Case Name                            :  SSO_CAS_Admin
'Author                                    :  Anil Kumar V
'Designed Date                             :  19 May 2015
'Last Modified By                          :  
'Last Modified Date                        :  
'###############################################################################################################
...
'****************************************Setting the Project Name in the environment variable*******************************************************
                ...
                environment("StrTestCaseID")="SSO_CAS_Admin"
                strModuleName= environment("strModuleName")				

                strTestCaseName= environment("TestName")
                environment("strTestCaseName")="SSO_CAS_Admin"
                StrStartTime=now
                StrBeginTimer=Timer
...
'#################################### TEST  CASE VALIDATION STARTS HERE ##################################################################################
                ...
                DataTable.ImportSheet environment("strDataFile"), "OSP_CAS_Admin", "Global"
...
'							Setting.WebPackage("ReplayType")=1
							...
							Call Func_Object_Exists(Obj_Lnk_CAS_admn)			
							Call Func_Do_Action(Obj_Lnk_CAS_admn,"TRUE","")
							
							If obj_Wbele_cas_pg.exist Then
								Func_CreateRow strDtlRptFileName,strTestCaseName,obj_Wbele_cas_pg.GetRoproperty("innertext")&" page displayed sucessfully ","Pass",now
							End If
							
							Call Func_Object_Exists(Obj_Wblst_srch_by)			
							Call Func_Do_Action(Obj_Wblst_srch_by,Environment("Search_By"),WebList)
							
							Call Func_Object_Exists(Obj_WbEdt_id)			
							Call Func_Do_Action(Obj_WbEdt_id,Environment("Id"),WebEdit)
							
							Call Func_Object_Exists(obj_Wbtn_srch)			
							Call Func_Do_Action(obj_Wbtn_srch,"TRUE","")
							
							If obj_Wbele_err_msg.exist(10) then
...
'Obj_WbEdt_id.Highlight
'Obj_WbEdt_id.Set "HppId"
